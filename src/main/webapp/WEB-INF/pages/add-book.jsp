		...
		<div class="jumbotron">
			<div align="right">
				<a class="btn btn-info" href="/logout">Logout</a>
							<br>Logged in User : ${loggedInUser}
			</div>

			<div>
				<h1 class="display-4">
					<c:if test="${addedBookTitle!=null}">
					Book  <b> ${book.title} </b> added successfully.
			...
			<c:if test="${addedBookTitle==null}">
				...
				<form:form method="post" action="add-new-book" name="addBookForm"
					modelAttribute="book">
						...
						<div class="card-body">
							<p class="card-text">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<form:input path="title" type="text"
												...
												id="title" placeholder="Book title" size="100"
												maxlength="150" value="${book.title}" />
								...
								<spring:bind path="price">
									<div class="form-group">
										<label class="col-sm-2 control-label">Price in Rs : </label>
										<div class="col-sm-10">
											<form:input path="price" type="number"
												class="form-control ${status.error ? 'is-invalid' : ''}"
												id="price" placeholder="Price in Rs" size="8"
												value="${book.price}" min="0.00" max="100000.00" step="0.01" />
								...
								<spring:bind path="volume">
									<div class="form-group">
										...
										<div class="col-sm-10">
											<form:input path="volume" type="number"
												class="form-control ${status.error ? 'is-invalid' : ''}"
												id="volume" placeholder="Volume" value="${book.volume}"
								...
								<spring:bind path="publishDate">
									<div class="form-group">
										...
										<div class="col-sm-10">
											...
											<form:errors path="publishDate" class="control-label" />
										</div>
									</div>
								</spring:bind>
